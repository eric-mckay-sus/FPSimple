...
internal static class Config
{
    ...
    public static string InputLocation  = @"P:\PE III\1-Standard Documents\FPM\+++SHEETS FOR DATABASE TESTING";
    ...
    public static readonly string[] DataHeaderNames = ["PROCESS FAILURE MODE", "RANK", "LOCATION", "DUMMY SAMPLE REQUIRED?"];
